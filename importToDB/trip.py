...
class Trip:
    ...
    def __init__(self, csvLine):
        ...
        [medallion, hack_license, vendor_id, rate_code, store_and_fwd_flag, 
             ...
             pickup_latitude, dropoff_longitude, dropoff_latitude] = csvLine
        
        #Parse coordinates from the cssv data
        self.fromLon = float(pickup_longitude)
        self.fromLat = float(pickup_latitude)
        self.toLon = float(dropoff_longitude)
        self.toLat = float(dropoff_latitude)
        self.dist = float(trip_distance)
        
        self.driver_id = hack_license
        ...
        self.pickup_time = parseUtc(pickup_datetime) #A datetime object
